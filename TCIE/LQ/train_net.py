...
from define_net_WXJ import Net_170_WXJ
from define_net_WXJ import Net_256_WXJ, Net_170_conv5, Net_140_WXJ,Net_80_conv5,Net_170_conv5_256
...
if __name__ == '__main__':
    ...
    trainset = ImageFolder(path_ + '/class1_lunwen/', imgsize, transform)
    trainloader = torch.utils.data.DataLoader(trainset,batch_size=128, shuffle=True, num_workers=1)
    testset = ImageFolder(r'D:\1WXJ\DATA\CLASS_Japan\devide_3\test\2017-2019\Delete_5_zong212_typhoon\A_0',imgsize, transform)
    testloader = torch.utils.data.DataLoader(testset, batch_size=1, num_workers=1)
    pathoutput = r"D:\1WXJ\Estimate\Model_2\class1_lunwen_3.2wan_0_BS_128"#
    pathlosssave = os.path.join(r'D:\1WXJ\Estimate\plot_2\class1_lunwen_3.2wan_0_BS=128')#
    ...
    net = Net_170_WXJ()
    # net.fc = nn.Sequential(nn.Linear(3200, 512),
    #                        nn.ReLU(),
    #                        # nn.Dropout(p=0.2),
    #                        nn.Linear(512, 64),
    #                        nn.ReLU(),
