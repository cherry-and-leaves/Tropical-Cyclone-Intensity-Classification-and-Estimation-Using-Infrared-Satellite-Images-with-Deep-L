...
if __name__ == '__main__':
    ...
    pathoutput = r"D:\1WXJ\Estimate\Model_2\Res_A_256_0_0.001_drop=0.1"#
    pathlosssave = os.path.join(r'D:\1WXJ\Estimate\plot_2\Res_A_256_0_0.001_drop=0.1')#
    ...
    net.fc = nn.Sequential(nn.Linear(512*4, 512),
                           nn.ReLU(),
                           nn.Dropout(p=0.1),
                           nn.Linear(512, 64),
                           nn.ReLU(),
