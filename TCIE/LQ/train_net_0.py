...
if __name__ == '__main__':
    ...
    trainset = ImageFolder(path_ + '/1and2_256_256_ZJ/', imgsize, transform)
    ...
    pathoutput = r"D:\1WXJ\Estimate\Model_2\Net_170_A_0_BS=32"#
    pathlosssave = os.path.join(r'D:\1WXJ\Estimate\plot_2\Net_170_A_0_BS=128')#
