...
from network import resnet34, resnet101, inceptionresnetv2,vgg19,vgg19_bn
...
if __name__ == '__main__':
    ...
    pathoutput = r"D:\1WXJ\Estimate\Model_2\VGG19_81_0.001_drop=0.5" #
    pathlosssave = os.path.join(r'D:\1WXJ\Estimate\plot_2\VGG19_81_0.001_drop=0.5') #
    ...
    model_path = r"D:\1WXJ\Estimate\Model\VGG19/"
    net = torchvision.models.vgg19(pretrained=True)
    print(net)
    # net.load_state_dict(torch.load(path_+'net_relu.pth'))
    # net = vgg19(pretrained=True, modelpath=model_path)  # batch_size=120, 1GPU Memory < 7000M
    ...
    # net.fc18 = nn.Sequential(
    #     nn.Linear(in_features=256, out_features=64, bias=True),
    #     nn.ReLU(),
    #     nn.Dropout(p=0.5)
    # )
    # net.fc19 = nn.Sequential(
    #     nn.Linear(in_features=64, out_features=1, bias=True)
    # )
    net.cuda()
    print(net)
