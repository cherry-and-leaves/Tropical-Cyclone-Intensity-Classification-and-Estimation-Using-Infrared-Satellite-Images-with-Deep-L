...
def inceptionresnetv2(num_classes=1000,modelpath='./models', pretrained='imagenet'):
    ...
    if pretrained:
        ...
        model.load_state_dict(model_zoo.load_url(settings['url'], model_dir=modelpath))
