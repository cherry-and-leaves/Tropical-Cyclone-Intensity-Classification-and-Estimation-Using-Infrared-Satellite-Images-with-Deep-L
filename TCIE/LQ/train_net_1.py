...
from define_net_WXJ import Net_256_WXJ,Net_170_conv5, Net_170_conv5_256,Net_170_conv4
...
if __name__ == '__main__':
    ...
    trainset = ImageFolder(path_+'/3TP_256/', imgsize, transform)#3TP_256 _ZJ_really
    # trainset = ImageFolder(path_ + '/3TP_256 _ZJ_really/', imgsize, transform)  # 3TP_256 _ZJ_really
    ...
    pathoutput = r"D:\1WXJ\Estimate\Model_2\A_1_noZJ_BS=128"#
    pathlosssave = os.path.join(r'D:\1WXJ\Estimate\plot_2\A_1_noZJ_BS=128')#
